...
#     '''
#     Serializer for the CustomUser model. Its send confirmation email to the new user if user does not exist.
#     '''
#
#     class Meta:
#         model = User
...
class CustomUserSerializer(serializers.ModelSerializer):
    '''
    Serializer for the CustomUser model. Its send OTP for activation email to the new user if user does not exist.
    '''
    class Meta:
        model = User
        fields = ('id', 'email', 'first_name', 'last_name', 'password')
